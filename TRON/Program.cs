...
namespace Void
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            if (Console.ReadLine().ToUpper() != "B8A3E7") { Console.WriteLine("Incorrect verification code. "); Console.ReadKey(); Environment.Exit(0); }
            Console.WriteLine("Have you read and agreed to the ToS at https://github.com/25bf3912/TRON/blob/master/TOS.md (Y/N): ");
            if (Console.ReadLine().ToUpper().Substring(0, 1) != "Y") { Console.WriteLine("Read and agree to the ToS at https://github.com/25bf3912/TRON/blob/master/README.md before continuing"); Console.ReadKey(); Environment.Exit(0); }
            Console.WriteLine("Enter the *verification code* from TOS.md: ");
            if (Console.ReadLine().ToUpper() != "D2A0C4") { Console.WriteLine("Incorrect verification code. "); Console.ReadKey(); Environment.Exit(0); }
            Console.WriteLine("Have you read and agreed to the ToS at https://github.com/25bf3912/TRON/blob/master/TOS.md (Y/N): ");
